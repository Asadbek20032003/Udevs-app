...
const System = () => {
  return (
    <div id="erp" className=" w-full py-[80px] bg-[#f4f7ff] ">
      <div className="container m-auto">
        ...
        <div className=" md:flex-row-reverse flex-col-reverse flex justify-center items-center md:justify-between mt-[80px]  ">
          <div className="w-full max-w-[500px] md:w-[48%] mb-[30px]">
            ...
            >
              <div className="pr-[20px] pb-[10px] pt-[10px] pl-[10px] mr-[15px] mb-[15px] rounded-[8px] bg-[#e0e8ff] ">
                <Image
                  ...
                  alt="CRM"
                />
                <span className="text-[#000] text-[18px] font-semibold leading-[30px]">CRM</span>
              </div>
              <div className="pr-[20px] pb-[10px] pt-[10px] pl-[10px] mr-[15px] mb-[15px] rounded-[8px] bg-[#e0e8ff]">
                <Image
                  className="mb-[12px] w-[56px] h-[56px]"
                  ...
                  alt="eLearning"
                />
                <span className="text-[#000] text-[18px] font-semibold leading-[30px]">eLearning</span>
              </div>
              <div className="pr-[20px] pb-[10px] pt-[10px] pl-[10px] mr-[15px] mb-[15px] rounded-[8px] bg-[#e0e8ff]">
                <Image
                  className="mb-[12px] w-[56px] h-[56px]"
                  ...
                  alt="E-Commerce"
                />
                <span className="text-[#000] text-[18px] font-semibold leading-[30px]">E-Commerce</span>
              </div>
              <div className="pr-[20px] pb-[10px] pt-[10px] pl-[10px] mr-[15px] mb-[15px] rounded-[8px] bg-[#e0e8ff]">
                <Image
                  className="mb-[12px] w-[56px] h-[56px]"
                  ...
                  alt="POS"
                />
                <span className="text-[#000] text-[18px] font-semibold leading-[30px]">POS</span>
              </div>
              <div className="pr-[20px] pb-[10px] pt-[10px] pl-[10px] mr-[15px] mb-[15px] rounded-[8px] bg-[#e0e8ff]">
                <Image
                  className="mb-[12px] w-[56px] h-[56px]"
                  ...
                  alt="Sms / Email"
                />
                <span className="text-[#000] text-[18px] font-semibold leading-[30px]">Sms / Email</span>
              </div>
              <div className="pr-[20px] pb-[10px] pt-[10px] pl-[10px] mr-[15px] mb-[15px] rounded-[8px] bg-[#e0e8ff]">
                <Image
                  className="mb-[12px] w-[56px] h-[56px]"
                  ...
                  alt="Warehouse"
                />
                <span className="text-[#000] text-[18px] font-semibold leading-[30px]">Warehouse</span>
              </div>
            </div>
          </div>
          <div className="w-full max-w-[500px] md:w-[48%] mb-[30px]">
            <div className="relative w-full h-full flex justify-center items-center rounded-[24px] overflow-hidden ">
              <Image
                src="https://udevs.io/static/bg_pattern-bfa00f19a06604ab492274cd3d9ea5cf.png"
                alt="Background pattern"
                className="w-full absolute h-full object-cover top-0 left-0 right-0 bottom-0 "
              />
              <Image
                data-aos="zoom-in"
                data-aos-duration="1200"
