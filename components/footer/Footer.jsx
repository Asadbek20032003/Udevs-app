...
const Footer = () => {
  return (
    <div className="pt-[48px] w-full text-center bg-[#f4f7ff] ">
      <div className="container m-auto ">
        ...
        <div className="flex sm:flex-row flex-col justify-between mt-[44px] mb-[32px] ">
          <div className="my-[20px] md:my-0 flex flex-col items-start md:text-[18px] text-[16px] md:leading-[32px] leading-[24px] md:mb-0 mb-[6px] text-[#1b5bf7] ">
            <h3 className="mb-[12px] mm:text-[16px] text-[1.2em] font-bold text-[#18191f] ">About us</h3>
            {/* margin-bottom: 6px; font-size: 16px; line-height: 28px; */}
            <a href="/directs">Direction</a>
            <a href="/team">Command</a>
            <a href="/tools">Tools</a>
            <a href="/clients">Clients</a>
          </div>
          <div className="my-[20px] md:my-0 flex flex-col items-start font-normal md:text-[18px] text-[16px] md:leading-[32px] leading-[24px] md:mb-0 mb-[6px] text-[#1b5bf7] ">
            <h3 className="mb-[12px]  mm:text-[16px] text-[1.2em] font-bold text-[#18191f] ">Services</h3>
            <a href="/mobile">Development of mobile applications</a>
            <a href="/erp">Development and implementation ERP systems</a>
            <a href="/design">User interface, User experience design</a>
            <a href="/consulting">IT consulting</a>
            <a href="/optimization">Optimization IT consulting infrastructure</a>
          </div>
          <div className="my-[20px] md:my-0 flex flex-col items-start md:text-[18px] text-[16px] md:leading-[32px] leading-[24px] md:mb-0 mb-[6px] text-[#1b5bf7] ">
            <h3 className="mb-[12px]  mm:text-[16px] text-[1.2em] font-bold text-[#18191f] ">Portfolio</h3>
        ...
        <div className="flex sm:flex-row flex-col-reverse justify-center items-center sm:justify-between w-full py-[25px] border-t-[1px] border-blue-500 border-opacity-20 ">
          <p className="text-[14px] leading-[24px] text-[#1b5bf7] font-medium  ">© 2024 Udevs. All rights reserved</p>
          <div className="flex items-center mb-[20px] sm:mb-0">
            <a
              href="/"
              className="flex content-center items-center mr-[16px] p-[7px] rounded-[50%] bg-[rgba(27,91,247,.1)] "
            >
              <svg
                className="text-[24px] w-[23px] h-[23px] "
                fill="#1b5bf7"
                focusable="false"
                viewBox="0 0 24 24"
                aria-hidden="true"
