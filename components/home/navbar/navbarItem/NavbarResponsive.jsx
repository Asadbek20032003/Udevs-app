...
const NavbarResponsive = ({ isOpen, toogleClose }) => {
  return (
    <div
      className={`mm:hidden flex flex-col justify-between fixed top-0 right-0 w-full h-screen bg-gray-100 transition-transform duration-400 ease-in-out transform ${
        isOpen ? "translate-x-0" : "translate-x-full"
      }`}
      // translateX="100vw"
    >
      <div className="relative items-center w-full h-[64px] z-[9999] flex justify-between px-[20px] ">
        <div className=" ">
          <Image
            width="96"
            height="42"
        ...
        <button
          onClick={toogleClose}
          className="flex justify-center items-center bg-transparent py-[1px] px-[6px] outline-none border-none color-[#1b5bf7] w-[32px] h-[32px] "
        >
          <svg
            className=" fill-[#1b5bf7] w-[1em] h-[1em] text-[1.5rem] flex-shrink-0 "
            fill="#1b5bf7"
            focusable="false"
            viewBox="0 0 24 24"
            aria-hidden="true"
      ...
      <ul className="flex items-center justify-center flex-col h-[50%] list-none m-0 ">
        <li className="mx-[16px] pl-0 ">
          <a href="/mobile" className="text-[32px] font-extrabold leading-[54px] text-[#18191f] mx-[16px] ">
            Services
          </a>
        </li>
        <li className="mx-[16px] pl-0 ">
          <a href="/clients" className="text-[32px] font-extrabold leading-[54px] text-[#18191f] mx-[16px] ">
            Clients
          </a>
        </li>
        <li className="mx-[16px] pl-0 ">
          <a href="/team" className="text-[32px] font-extrabold leading-[54px] text-[#18191f] mx-[16px] ">
            Command
          </a>
        </li>
      </ul>
      <div className=" px-[20px]  ">
        <div className="w-full max-w-full py-[13px]  text-center rounded-[8px] bg-[#1b5bf7] hover:scale-[1.01] transition-all duration-[0.2s] ">
          <a href="/contact" className=" px-[16px] text-[20px] leading-[30px] font-semibold text-[#fff]   ">
            Contact
          </a>
        </div>
        <div className="flex justify-center w-full my-[40px]  ">
          <span className="flex justify-center items-center w-[40px] h-[40px] mr-[24px] rounded-[50%] bg-[#1b5bf7] text-[#fff]  ">
            <svg
              className="fill-[#fff] w-[1em] h-[1em] text-[1.5rem] "
              focusable="false"
              viewBox="0 0 24 24"
              aria-hidden="true"
            >
          ...
          <span className="flex justify-center items-center w-[40px] h-[40px]  rounded-[50%] bg-[#1b5bf7] text-[#fff]  ">
            <svg
              className="fill-[#fff] w-[1em] h-[1em] text-[1.5rem] "
              focusable="false"
              viewBox="0 0 24 24"
